...
class BtcFactorStrategy(Strategy):
    ...
    def pair_order_target(self, target: float, direction: str) -> int:
        """
        ...
        """
        # if self.current_hold_amount == target:
        #     return 1
        # if self.current_hold_amount >= target and (direction == Direction.OPEN_LONG or direction == Direction.OPEN_SHORT):
        #     return 1
        # if self.current_hold_amount <= target and (direction == Direction.CLOSE_LONG or direction == Direction.CLOSE_SHORT):
        #     return 1
        # if direction == Direction.OPEN_LONG and self.current_hold_amount < target:
        # TODO:implement me
